...
| **WEB-DEMO-UNIFIED** | **DOING** — trace, server session, canonical step và AdviceCheckpoint bridge đã `DONE-CODE`; còn Web render/display ACK và visual gate. Không đổi SimPy thành live engine, không gọi solver theo click | UPDATE-128..131 + `docs/superpowers/plans/2026-08-04-unified-web-demo-implementation.md` | phụ thuộc visual V-25; live Agent vẫn ngoài scope |
