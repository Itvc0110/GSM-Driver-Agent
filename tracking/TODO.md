...
| **WEB-DEMO-UNIFIED** | **DOING** — observer replay trace đã có (`UPDATE-128`); kế tiếp server session/canonical step/API/Web render. Không đổi SimPy thành live engine, không gọi solver theo click | UPDATE-128 + `docs/superpowers/plans/2026-08-04-unified-web-demo-implementation.md` | phụ thuộc visual V-25; live Agent vẫn ngoài scope |
