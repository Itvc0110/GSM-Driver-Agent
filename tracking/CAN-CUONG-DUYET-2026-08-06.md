...
| **Nghiêm trọng tới đâu** | Phản biện độc lập **CONFIRMED bởi cả hai góc soi**, và đo được: nhiễm THUẦN (kênh bật, **0 can thiệp**) làm fingerprint khác **5/5 seed**; payout lệch **±0,7–3,0%**; `rest_min` lệch **±391′**. Nhiễu này **cùng bậc hoặc lớn hơn** chính hiệu ứng cần đo ⇒ **phương sai của Δ sau D-M3-04-FIX gần như TOÀN BỘ là nhiễu trôi-stream** |
...
| `D-ADV-02` | `shift_extend` mù cửa sổ điểm — **20,8%** lượt kéo nằm **hoàn toàn** trong giờ 0 điểm (đo: **0 điểm / 5 cuốc**), mỗi ca viện dẫn `gap_vnd = 30.000đ` cho cửa sổ có `E[Δthưởng] = 0` | Phụ thuộc `D-ADV-04b`. ⚠ **Cách sửa tôi đề xuất ban đầu là SAI** (làm kênh gần như trơ — còn 13,6%); bản đúng là walk **từ `now`** (giữ 66%) |
