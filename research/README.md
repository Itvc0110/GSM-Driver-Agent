...
| `ux/` | Nghiên cứu UX/HCI cho advisor: nudge patterns, driver-distraction, agent-trace và Core Agent presentation-only | `2026-07-27-decision-trace-design-note.md`; `2026-07-30-core-agent-uiux-research-draft.md` (**RESEARCH DRAFT, chưa phải spec/thiết kế chốt**) |
| `audit/` | Audit code/data/model + hồ sơ trạng thái đã reconcile | `2026-07-26-full-audit/REPORT.md`; `2026-07-27-r5-selfcheck/adapter-findings.md`; `2026-07-29-cycle-w-review/findings.md`; **đọc mới nhất:** [`2026-08-03-advice-checkpoint/findings.md`](audit/2026-08-03-advice-checkpoint/findings.md) (chuỗi Simulator→Solver→Advice→Agent→UI: sim và sản phẩm là **ảnh gương lỗi của nhau**; `AdvisorPipeline` mồ côi — UPDATE-121) |
