...
Seeds: 30 (base 200). driver-days: bike=2744, car=1052. Nguồn benchmark: `research/simulation/realism-benchmarks.md`.
...
|---|---|---|---|---|---|---|
| cuốc/tài xế/ngày | 13.00 | 7.00 | 21.00 | 10–30 | PASS | sim baseline ~16 (biên dưới); thực FT median 18-22 |
| payout(commission)/ngày VND | 186,862 | 102,232 | 315,022 | 150000–550000 | PASS | sim ~300k (thiếu lớp thưởng); thực 380-480k |
| giờ online/ngày | 8.80 | 5.21 | 12.09 | 2–12 | PASS | sim FT median ~4.5h (T-021 gap; thiết kế 8-10h) |
| tỷ lệ nhận | 0.91 | 0.75 | 1.00 | 0.6–1.0 | PASS | eligibility thưởng ≥0.85; archetype 0.74-0.97 |
| % cuốc khung rush | 0.40 | 0.18 | 0.67 | 0.1–0.7 | PASS | 2 đỉnh 6-8h,16-18h |
...
| payout(commission)/ngày VND | 591,520 | 199,832 | 1,495,448 | — | OBSERVE | car — không dùng benchmark bike |
| giờ online/ngày | 10.45 | 6.26 | 15.75 | — | OBSERVE | car — không dùng benchmark bike |
| tỷ lệ nhận | 0.88 | 0.75 | 1.00 | — | OBSERVE | car — không dùng benchmark bike |
| % cuốc khung rush | 0.50 | 0.33 | 0.67 | — | OBSERVE | car — không dùng benchmark bike |
| % cuốc 5 sao | 0.79 | 0.67 | 0.89 | — | OBSERVE | car — không dùng benchmark bike |
