...
1. **Đọc lại docs trước khi thực thi** — tối thiểu: **`tracking/DIRECTIVES-2026-07-24.md` (chỉ thị chương trình — ĐỌC ĐẦU TIÊN)**, `planning/SCOPE.md`, `tracking/TODO.md`, `tracking/DEFERRED.md`, `tracking/ASSIGNMENTS.md`, và 2–3 file UPDATE mới nhất trong `tracking/updates/`. Task chạm vào phần nào thì đọc thêm docs liên quan phần đó. Không được bỏ qua bước này kể cả khi task "có vẻ nhỏ".
